"""
# Переиспользуем функции построения банка, загрузки IQ и расчёта score из math_template_classifier
"""
...
# Собирает один .npz файл или все .npz файлы внутри папки
...
# Точка входа: строит банк эталонов, классифицирует .npz-файлы и сохраняет CSV с результатами
def main() -> None:
