#!/usr/bin/env python3
"""
Этот файл генерирует синтетический IQ-датасет для классических методов.
"""
...
# Генерирует синтетический IQ-датасет, сохраняет .npz-файлы и таблицу metadata.csv
# Каждый .npz содержит комплексный сигнал iq, частоту дискретизации fs и ОСШ snr_db
# metadata.csv связывает каждый IQ-файл с классом, доменом, семейством, ОСШ и параметрами генерации
...
# Описывает параметры генерации IQ-датасета из командной строки
def build_argparser() -> argparse.ArgumentParser:
	p = argparse.ArgumentParser(description="Generate synthetic RF IQ datasets for classical ML baselines.",
