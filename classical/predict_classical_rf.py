#!/usr/bin/env python3
"""
predict_classical_rf.py

Run a saved classical RF classifier on IQ .npz files.
"""
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Predict RF signal class/domain/family with a classical model.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
